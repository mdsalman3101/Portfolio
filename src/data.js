export const fallbackProjects = [
  { id:'weather', title:'WeatherGPT', slug:'weathergpt', category:'AI Â· WEATHER Â· PRODUCT', summary:'A featured weather experience designed for intelligent, conversational forecasts. Project media can be published from the admin dashboard.', tags:['React','JavaScript','API'], featured:true, published:true, sort_order:0 },
  { id:'ecommerce', title:'E-Commerce Website', slug:'e-commerce', category:'WEB Â· COMMERCE', summary:'A responsive shopping experience with product browsing, cart and checkout functionality.', tags:['HTML','CSS','JavaScript'], github_url:'https://github.com/mdsalman3101/E-Commerce', live_url:'https://mdsalman3101.github.io/E-Commerce/', published:true, sort_order:1 },
  { id:'cybersafe', title:'CyberSafe', slug:'cybersafe', category:'SECURITY Â· WEB', summary:'A web project focused on practical cyber-safety awareness and accessible security guidance.', tags:['HTML','CSS','JavaScript'], github_url:'https://github.com/mdsalman3101/CyberSafe', live_url:'https://mdsalman3101.github.io/CyberSafe/', published:true, sort_order:2 },
  { id:'tasks', title:'Task Manager', slug:'task-manager', category:'PRODUCTIVITY Â· WEB', summary:'A focused task-management experience for organizing everyday work.', tags:['JavaScript','HTML','CSS'], github_url:'https://github.com/mdsalman3101/TaskMangers', published:true, sort_order:3 }
]
...
export const defaults = {
 ...
 about:{ text:'Iâ€™m a Computer Science Engineering student at Ganpat University who enjoys turning ideas into fast, approachable web experiences. I work across frontend interfaces, APIs and databasesâ€”and keep learning by building.' },
